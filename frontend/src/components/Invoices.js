...
export default function Invoices() {
    ...
    useEffect(async () => {
        ...
        //     console.log(decode)
            ...
            let data = []
            await fetchproduct({ email: "akash111pl@gmail.com" }).then(res => {
                data = [...res.data]
    ...
    return (
        <div  className="container-fluied"  style={{backgroundColor:"lightblue"}}>
            <h5 className='text-center'>Invoices</h5>
